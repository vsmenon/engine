...
class EngineParagraph implements ui.Paragraph {
  ...
  ui.Paragraph _cloneWithText(String plainText) {
    return EngineParagraph(
      plainText: plainText,
      paragraphElement: _paragraphElement.clone(true) as HtmlElement,
...
class EngineParagraphBuilder implements ui.ParagraphBuilder {
  ...
  final html.HtmlElement _paragraphElement = domRenderer.createElement('p') as HtmlElement;
  ...
  EngineParagraph _buildRichText() {
    ...
    for (int i = 0; i < _ops.length; i++) {
      ...
      if (op is EngineTextStyle) {
        final html.SpanElement span = domRenderer.createElement('span') as SpanElement;
